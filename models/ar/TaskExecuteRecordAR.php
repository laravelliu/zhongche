...
/**
 * This is the model class for table "zc_task_execute_record".
 *
 ...
 */
class TaskExecuteRecordAR extends \app\models\ar\BaseAR
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['task_id', 'workshop_id', 'work_area_id', 'job_station_id', 'type_id', 'quality_inspection_group_id', 'quality_inspection_group_type', 'process_id', 'user_id', 'user_check_id', 'default_work_area', 'execute_status', 'is_doing_random_inspection', 'create_time', 'update_time'], 'integer'],
            [['mark'], 'string', 'max' => 255],
        ];
    }
